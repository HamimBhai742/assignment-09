...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div className="hero min-h-screen lg:bg-base-200 rounded-xl max-sm:my-5">
                <div className="hero-content flex-col lg:flex-col">
                    <div className="text-center lg:text-left">
                        <h1 className="md:text-5xl text-3xl font-bold font-poppins">Login now!</h1>
                    </div>
                    <div className="card shrink-0 md:w-[552px]  shadow-2xl bg-base-100 mt-3">
                        <form onSubmit={handelLoginSubmitForm} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <label className="label relative">
                                    <input name='password' type={showPassword ? 'text' : 'password'} placeholder="Enter your password" className="input font-poppins w-full  md:w-[552px]  input-bordered" required />
                        ...
                        <div className='max-sm:px-8'>
                            <div onClick={loginWithGoogle} className='border-2 border-[#328EFF48] text-[#328EFF] rounded-xl p-3 flex gap-3 items-center md:w-1/2 mx-auto'>
                                <span className=' text-xl'><FaGoogle></FaGoogle></span>
                                <span className='md:text-lg font-semibold'>Login with Google</span>
                            </div>
                            <div onClick={handelGitHub} className='border-2 my-3 rounded-xl p-3 flex gap-3 items-center md:w-1/2 mx-auto'>
                                <FaGithub className=' text-2xl'></FaGithub>
                                <span className='md:text-lg font-semibold'>Login with GitHub</span>
                            </div>
                        </div>
                    </div>
                </div>
